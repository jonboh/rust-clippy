...
#![allow(clippy::reserve_after_initialization, clippy::unnecessary_operation)]
...
fn isolated() {
    ...
    let array: &[usize] = &[1, 2];
    let array2: &[usize] = &[3, 4, 5];
    //// do not lint
    vec.reserve(array.len()); // FIX:
    vec.extend(array2);
}
...
//     let other_map: HashMap<usize, usize> = HashMap::new();
//     // do not lint
